...
//
// API "FIFA Tracker": account TestHelpers
//
// Command:
// $ goagen
...
func DeleteAccountBadRequest(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountController, accountID int) (http.ResponseWriter, error) {
	...
	u := &url.URL{
		Path: fmt.Sprintf("/account/%v", accountID),
	}
...
// DeleteAccountInternalServerError runs the method Delete of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func DeleteAccountInternalServerError(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountController, accountID int) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// DeleteAccountUnauthorized runs the method Delete of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func DeleteAccountUnauthorized(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountController, accountID int) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListAccountInternalServerError(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountController) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListAccountOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountController) (http.ResponseWriter, app.FtAccountCollection) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	var mt app.FtAccountCollection
	if resp != nil {
		var ok bool
		mt, ok = resp.(app.FtAccountCollection)
		if !ok {
			t.Fatalf("invalid response media: got %+v, expected instance of app.FtAccountCollection", resp)
		}
		_err = mt.Validate()
		if _err != nil {
...
// ListAccountUnauthorized runs the method List of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListAccountUnauthorized(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountController) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowAccountOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountController, accountID int) (http.ResponseWriter, *app.FtAccount) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	var mt *app.FtAccount
	if resp != nil {
		var ok bool
		mt, ok = resp.(*app.FtAccount)
		if !ok {
			t.Fatalf("invalid response media: got %+v, expected instance of app.FtAccount", resp)
		}
		_err = mt.Validate()
		if _err != nil {
			t.Errorf("invalid response media type: %s", _err)
...
// ShowAccountUnauthorized runs the method Show of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowAccountUnauthorized(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountController, accountID int) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func UpdateAccountInternalServerError(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountController, accountID int, payload *app.UpdateAccountPayload) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func UpdateAccountOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountController, accountID int, payload *app.UpdateAccountPayload) (http.ResponseWriter, *app.FtAccount) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// UpdateAccountUnauthorized runs the method Update of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func UpdateAccountUnauthorized(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountController, accountID int, payload *app.UpdateAccountPayload) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
